...
▢ ${msg.gp} 1
https://www.instagram.com/slova_mandarina/

▢ *YouTube*
• https://www.youtube.com/channel/UCDU48I-jToFYiz14BqLsVeQ
`
m.reply(gps)
break 
...
*≡ OWNER*
▢ Instagram : https://www.instagram.com/slova_mandarina/
▢ WhatsApp : wa.me/593959048464

*≡ SCRIPT*
▢ Git : ${package.homepage} 
` 
Fg.send2Button(from, teks, '*_©Slova*', `ꨄ︎ Apoyar`, `${prefix}donate`, `⌬ ${msg.gp}s`, `${prefix}grupos`)
   break
...
▢ *Pregunta:* ${value}
▢ *Respuesta :* ${prefg.success.replace('simsimi', 'Slova').replace('Simsimi', 'Slova').replace('sim simi', 'Slova')}`) 
break 
...
Fg.send2ButtonLoc(from, welm, capt, 'Sígueme en Instagram\nhttps://www.instagram.com/slova_mandarina/', '⦙☰ MENU', '/menu', '⏍ INFO GP', '/infogp', false, {
	      contextInfo: { 
            mentionedJid: Fg.parseMention(capt)
	      } 
	    }); //--
...
case 'bot':
        ...
        m.reply(result.success.replace('simsimi', 'Slova').replace('Simsimi', 'Slova').replace('sim simi', 'Slova'))
                     break
 case 'suit':
 case 'ppt':
